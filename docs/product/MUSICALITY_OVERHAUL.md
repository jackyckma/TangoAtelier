...
**狀態（2026-08-20）：** M1–M4、M10 已合 `main`。Founder 人耳主訴：**變化不服從情緒**（突停句、穩段急音、variation 缺推進、和弦太故意）。下一刀：**連續性／期待感閘門** → M6 → **克制版 M5**（見 §M5 動機補充）。

（M1–M3 當初可平行；M3 作驗收工具的原則不變。）
...
**層級：** Skeleton / harmony
**依賴：** M1、M2；建議在「連續性／期待感閘門」與 M6 弧線約束之後再做（或與閘門同批但 colour 預設極低）
**預估：** 中
...
**Founder 2026-08-20：** 現況聽感是和弦「太故意換」——M5 **禁止**為了統計熵／表面多樣性而堆 colour。預設走 tonic↔subdominant↔dominant 服務樂句張力；`colour`／次屬／借用只在 `tension` 高或 climax 鄰近開啟。DoD 的「熵顯著升高」若與人耳衝突，以人耳與克制為準。
